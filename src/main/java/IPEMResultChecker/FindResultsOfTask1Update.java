...
public class FindResultsOfTask1Update implements Task1Results{
    //Gr 5 row 1, gr 4, row 1
    int price; //14000
    int demand; //4000
    ...
    public String calculateSafetyMarginOfPrice() {
        double minimumPriceAtLowerOfDemand = (double) (unitVariableCost + (fixedCosts/demand));
